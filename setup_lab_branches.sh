...
# Creates sample branches with tasks, Jenkins validation and .gitreview in interflo repo for lab{4,5,7} for student with username interflo123.

if ! command -v rsync &> /dev/null; then
    echo "rsync not found, please install the command and rerun the script ${0}"
    echo "Branches for interflo haven't been created."
    exit 1
fi
...
lab_examples_dir='../interflo-projects'
student_username='interflo123'
...
do
 ...
 echo "Sample branches  for interflo have been created !"
